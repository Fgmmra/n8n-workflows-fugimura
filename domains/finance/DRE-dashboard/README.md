...
|---------|-----------|------|
| `Atualização Dashboard financeiro.json` | Workflow n8n — importar diretamente | [📥 Baixar](https://github.com/Fgmmra/n8n-workflows/edit/main/domains/finance/DRE-dashboard/Atualização_Dashboard_financeiro.json) |
| `script Planilha.js` | Macro Google Apps Script — colar no GAS | [📄 Ver arquivo](https://github.com/Fgmmra/n8n-workflows/edit/main/domains/finance/DRE-dashboard/script_Planilha.js) |
